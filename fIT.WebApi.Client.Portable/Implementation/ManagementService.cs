...
namespace fIT.WebApi.Client.Portable.Implementation
{
  ...
  public class ManagementService : IManagementService, IDisposable
  {
    ...
    public async Task<bool> PingAsync()
    {
      ...
      try
      {
        result = await this.client.GetAsync("/api/accounts/Ping");
      }
      catch (Exception e)
      {
        Debug.WriteLine(e);
    ...
    /// <summary>
    /// Logs in by using a valid refresh Token
    /// </summary>
    /// <param name="refreshToken"></param>
    /// <returns></returns>
    public async Task<IManagementSession> LoginAsync(string refreshToken)
    {
