...
\newcommand*{\thetitle}{Verl{\"a}ssliche mobile \mbox{Anwendungen}}
\newcommand*{\thesubtitle}{Untersuchungen am Beispiel einer \mbox{Fitness-App}}
...
\newcommand*{\thedegree}{Bachelor in Information Technology}
...
\begin{document}
  ...
  \linespread {1.25}\selectfont %Zeilenabstand: 1.25 da er von Haus aus 1.2 ist und 1,25 * 1,2 = 1,5
	...
	\input{content/aspekte_realisierung}	
	\input{content/server}
	\input{content/native_app}
	\input{content/webapplikation}
	\input{content/gegenueberstellung}
	\input{content/weiterentwicklung-messeprototyp}
