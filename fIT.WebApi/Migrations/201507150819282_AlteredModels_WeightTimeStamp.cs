namespace fIT.WebApi.Migrations
{
  ...
  public partial class AlteredModels_WeightTimeStamp : DbMigration
  {
    public override void Up()
    {
      ...
      DropColumn("dbo.Practices", "Timestamp");
      AddColumn("dbo.Practices", "Timestamp", c => c.DateTime(nullable: false));
    ...
    public override void Down()
    {
      ...
      DropColumn("dbo.Practices", "Timestamp");
      AddColumn("dbo.Practices", "Timestamp", c => c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"));
