...
namespace fIT.WebApi.Repositories
{
    public class AuthRepository : IDisposable
    {
        ...
        public AuthRepository()
        {
            ...
            _userManager = new UserManager<UserInformation>(new UserStore<UserInformation>(_ctx));
        }
        ...
        {
            var result = await _userManager.CreateAsync(userModel.ToUserInfo(), userModel.Password);
